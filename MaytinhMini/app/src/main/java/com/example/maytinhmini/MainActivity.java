package com.example.maytinhmini;
...
public class MainActivity extends AppCompatActivity {
    Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b0, bdot, bpi, bequal, bcong, btru, bnhan, bchia;
    Button b1x, bsqrt, bbinh, bgiaithua, bln, blog, btan, bcos, bsin, bb1, bb2, bc, bac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bsqrt = findViewById(R.id.bmu);
        bbinh = findViewById(R.id.bbinh);
        //      bgiaithua = findViewById(R.id.bgiaithua);
...
//        bc = findViewById(R.id.bc);
      ...
      /*  bb1.setOnClickListener(new View.OnClickListener() {
        ...
        /*bgiaithua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        bbinh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
